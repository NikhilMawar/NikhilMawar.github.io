        ...
        <div className=" mx-auto h-full w-full max-w-[1920px] px-[clamp(20px,2.6vw,50px)] py-[clamp(95px,6.8vw,130px)]">
          ...
          <div className="grid grid-cols-12 gap-x-[clamp(24px,3vw,58px)] pt-[clamp(32px,2.6vw,50px)]">
            ...
            <div className="col-span-12 lg:col-span-7">
              ...
              {/*<p
                className="max-w-[940px] font-['Inter'] text-[clamp(16px,1.04vw,20px)] leading-[1.2] tracking-[-0.02em]"
                style={{ color: colors.subtext }}
              >
                My journey into product design began with a curiosity for solving problems through technology and thoughtful user experiences. Over the years, I've worked on products across rental marketplaces, fintech, healthcare, e-commerce and AI-driven experiences, refining my ability to transform complex challenges into intuitive, user-centered solutions. Today, I focus on designing products that balance business goals with usability, creating digital experiences that are simple, scalable and meaningful.
              </p>*/}
              ...
              <div className="mt-[clamp(34px,2.8vw,54px)]">
                <div className="relative mb-[clamp(18px,1.5vw,28px)]">
                  ...
                  <div className="absolute left-0 top-1/2 grid w-full -translate-y-1/2 grid-cols-5">
                    {steps.map((_, index) => {
                        const revealEnd = 0.7;
                      const threshold = (index / (steps.length - 1)) * revealEnd;
